...
async function NftManager_init(
	owner: Address,
	debug: bigint,
	mint_price: bigint,
	max_supply: bigint
...
export class NftManager implements Contract {
	...
	async send(
		...
		message: SetNftCollectionAddress | MintSafe | Deploy
	) {
