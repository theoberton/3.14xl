...
interface DatePickerProps {
  ...
  disablePast?: boolean;
  popperProps : {placement: string;}; // FIX later
  placeholder: string;
  maxDate?: Date;
  minDate?: Date;
...
function DatePickerComponent({
  ...
  const convert = (date: Date, applidFormat: string) =>
    format(new Date(date), applidFormat);
  ...
  const handleChangeDate = useCallback(
    (popperInputValue: any, keyBoardInputValue: any) => {
      ...
      if (popperInputValue && !keyBoardInputValue) {
        ...
        const isKeyBoardInputValueValid =
          DATE_VALIDITY_REGEX.test(keyBoardInputValue);
        ...
        renderInput={({ inputRef, inputProps, InputProps }) => (
          <div className={inputContainerClass}>
            ...
            <div className={datePickerWrapperClass}>
              ...
              />
              <i className={styles.datePickerItem}>
