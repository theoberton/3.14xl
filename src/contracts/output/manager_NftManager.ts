...
export function loadMintSafe(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1200160875) { throw Error('Invalid prefix'); }
    let _query_id = sc_0.loadUintBig(64);
