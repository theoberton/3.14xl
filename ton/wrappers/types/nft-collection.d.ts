...
export interface GetStaticDataParams { queryId?: number };
export interface GetRoyaltyParams { queryId?: number };
...
export declare class NftCollection implements Contract {
  ...
  getNftItemContent(provider: ContractProvider, index: number, individualContent: Cell): Promise<NftItemContent>;
